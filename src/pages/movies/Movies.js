    ...
    return(
        <>
            ...
            <div className='trending' >
                {
                    content?content.map(c=><SingleContent key={c.id} id={c.id} poster={c.poster_path} title={c.title || c.name} date={c.first_air_date || c.release_date} media_type='movie' vote_average={c.vote_average} />):console.log('nope')
                }
            </div>
